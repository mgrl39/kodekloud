...
[LINK](https://studio.kodekloud.com/labs/docker/docker_cmd_entrypoint) - 09/08/2025 - 20minutes.

**Dockerfiles for a few commonly used Docker Images are given in the `/root` (current) directory. Inspect them and tr to answer the following questions.**
```bash
~ ➜  pwd
/root
...
~ ➜  
```
In this case --> `docker-entrypoint.sh`
...
In this case --> `apache2-foreground`
...
~ ➜  
```
IN this case --> `docker-entrypoint.sh apache2-foreground`
...
### Run an instance of the `ubuntu` image to run tthe `sleep 1000` command at startup.
**Run it in detached mode.**
```bash
~ ➜  docker run -d ubuntu sleep 1000
cc041ec95516122a8576c1a003768920bfde791ef6fe841b1d9ba6a3d1700d98
```
